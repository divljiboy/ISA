...
public class AdminJelovniciController extends HttpServlet {

	private static final long serialVersionUID = -7933312091655026572L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (session.getAttribute("admin") != null) {
			...
			session.setAttribute("jelaAdmin", jela);
			getServletContext().getRequestDispatcher("/jelovniciJela.jsp")
					.forward(req, resp);
		}
	}
}
